...
// $plain_signature = $apiToekn.':'.$host.':'.$locale.':'.$partnerId.':'.$adult.':'.$children.':'.$infants.':'.$departure_date.':'.$destination.':'.$origin.':'.$arrival_date.':'.$destination.':'.$origin.':'.$trip_class.':'.$user_ip;
// echo $plain_signature.'<br>';
// echo md5($plain_signature);